...
$(document).ready(function()
{
    ...
    var html =  "<div style=\"border: 1px solid #ccc;padding:10px;\" >"
        ...
        + "<input type=\"text\" id=\"WebChatNameID\" placeholder=\"Укажите ваше имя...\" > <div id=\"answer_div\" style=\"float:right;\" ></div>"
        + "<textarea id = \"WebChatTextID\" placeholder = \"Отправьте сообщение в online чат...\" ></textarea>"
